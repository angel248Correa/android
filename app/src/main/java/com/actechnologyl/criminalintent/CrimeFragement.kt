        ...
        crimeDetailViewModel.CrimeLiveData.observe(
            ...
            androidx.lifecycle.Observer { crime ->
                crime?.let {
                    ...
                    "com.actechnology.criminalintent",
                    photoFile)
                    updateUI()
                }
            })
    ...
    override fun onStart() {
        ...
        dateButton.setOnClickListener {
            DatePickerFragment.newInstance(crime.date).apply {
                ...
                show(this@CrimeFragement.requireFragmentManager(), DIALOG_DATE)
            }
        }
        ...
        photoButton.apply {
            ...
            setOnClickListener{
                ...
                requireActivity().grantUriPermission(cameraActivity.activityInfo.packageName, photoUri,
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        when {
            ...
            requestCode == REQUEST_CONTACT && data != null -> {
                ...
                cursor?.use {
                    // Verify cursor contain at least one  result
                    if(it.count == 0 ){
                    return
                    }
